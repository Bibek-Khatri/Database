...
#5. Display the first name, current date, date of birth, and age of employees who 
#are older than 20 years.

SELECT FirstName,CURADTE() as DateofBirth from employee;
DateofBirth,
timestampdiff(YEAR,DateofBirth,CURDATE()) as age
from employee
where
timestampdiff(YEAR,DateofBirth,CURRENT()) > 20;
...
#9. Display the minimum salary department-wise.
